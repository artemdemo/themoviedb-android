...
public class ApiFactory {
	...
	public static String getMoviesByYearUrl( int intYear, int intPage) {
		...
		String strUrl = strApiURL + "discover/movie?year=" + Integer.toString(intYear) + "&page=" + Integer.toString(intPage) + "&with_genres=&api_key=" + strApiKey;
		return strUrl;
	};
	...
	public static String getMoviesByYearAndTitleUrl( int intYear, String strTitle, int intPage) {
		String strUrl = strApiURL + "discover/movie?year=" + Integer.toString(intYear) + "&query=" + strTitle + "&page=" + Integer.toString(intPage) + "&with_genres=&api_key=" + strApiKey;
		return strUrl;
	};
